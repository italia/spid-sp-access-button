...
case"enable":return s(),t(this).removeClass("spid-idp-button-disabled")}}}),t(document).on("click.spid-idp-button","[spid-idp-button]",i),t(document).on("click.spid-idp-button",s),t(window).on("resize",e)}(jQuery)/* Credits to jquery-dropdown - https://github.com/claviska/jquery-dropdown */